...
class __$$_IdleCopyWithImpl<T, $Res>
    extends _$BaseBlocStateCopyWithImpl<T, $Res, _$_Idle<T>>
...
abstract class _Idle<T> implements BaseBlocState<T> {
...
class __$$_SuccessCopyWithImpl<T, $Res>
    extends _$BaseBlocStateCopyWithImpl<T, $Res, _$_Success<T>>
...
class _$_Success<T> implements _Success<T> {
  ...
  @override
  String toString() {
    return 'BaseBlocState<$T>.success(data: $data)';
  }
